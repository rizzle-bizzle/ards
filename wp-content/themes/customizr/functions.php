...
if (function_exists('register_sidebar')) {	register_sidebar(array(		'name'=> 'Testimonial',		'id' => 'testimonials',		'before_widget' => '<li id="%1$s" class="widget %2$s">',		'after_widget' => '</li>',		'before_title' => '<h2 class="testimonial-title">',		'after_title' => '</h2>',	));}
if (function_exists('register_sidebar'))
{	register_sidebar(array(		'name'=> 'proposal',		'id' => 'proposal',		'before_widget' => '<span>',	'after_widget' => '</span>',	'before_title' => '<h2 class="proposal-title">',		'after_title' => '</h2>',	));}
